    ...
    function Initialize(data) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            google.maps.event.addListener(marker, 'click', (function (marker, i) {
                ...
                return function () {
                    infowindow.setContent("<div class='infoDivo'><p><strong>Exakt läge: </strong>" + data[i]["ExactLocation"] + "</p>" + "<p><strong>Kategori: </strong>" + data[i]["SubCategory"] + "</p>" + "<p><strong>Tid: </strong>" + data[i]["CreatedDate"] + "</p></div>");
                    map.setZoom(15);
